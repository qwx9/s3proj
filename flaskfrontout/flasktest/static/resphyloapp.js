...
//function loadparamsout(jsonlikestring){
 //   var user = JSON.parse(jsonlikestring);
  //  var paramsout = "quelconque";
  //  alert(user);
 //   return paramsout;
//}
...
/*
function vv(){
    var treeNewickString = document.getElementById('show2').innerHTML;
    return treeNewickString
}*/
...
function paramsResults(){
    ...
    var display2 = document.createElement("TEXTAREA"); // https://www.w3schools.com/js/js_htmldom_nodes.asp
    display2.setAttribute("id","pulledparameters");
    var t = document.createTextNode("heheheheh"); 
